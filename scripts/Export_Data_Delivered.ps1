...
#    $endDate = "jeudi 27 juillet 2023 23:59:00"
 #  $startDate = "jeudi 27 juillet 2023 00:00:00"
...
do {
  ...
  Write-Host "Starting message trace until $($gmtParams.StartDate) TO $($gmtParams.EndDate) email : $($User)"
  ...
  do {
    ...
    $currentMessages = Get-MessageTrace @gmtParams -Status "Delivered" | Group-Object -Property RecipientAddress | Select name
    $gmtParams.Page++
	Add-Content ./Results/Delivered/$outFilePath $currentMessages.Name
