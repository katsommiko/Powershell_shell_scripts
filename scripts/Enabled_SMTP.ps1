...
Write-host "Please wait For Enabled SMTP  : " -ForegroundColor Yellow -NoNewline
 
Try
{
	
	$aa=Set-TransportConfig -SmtpClientAuthenticationDisabled:$false -ErrorAction stop
